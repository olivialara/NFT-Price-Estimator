...
def set_value():
    ...
    with col1:
        ...
        st.markdown(f"Estimated Value: ${high_punks[0][1]}")
        ...
        st.markdown(f"Estimated Value: ${high_punks[5][1]}")
    ...
    with col2:
        ...
        st.markdown(f"Estimated Value: ${high_punks[1][1]}")
        ...
        st.markdown(f"Estimated Value: ${high_punks[6][1]}")
    ...
    with col3:
        ...
        st.markdown(f"Estimated Value: ${high_punks[2][1]}")
        ...
        st.markdown(f"Estimated Value: ${high_punks[7][1]}")
    ...
    with col4:
        ...
        st.markdown(f"Estimated Value: ${high_punks[3][1]}")
        ...
        st.markdown(f"Estimated Value: ${high_punks[8][1]}")
    ...
    with col5:
        ...
        st.markdown(f"Estimated Value: ${high_punks[4][1]}")
        ...
        st.markdown(f"Estimated Value: ${high_punks[9][1]}")
...
def set_averages():
    ...
    if menu_set_averages == "Types":
        ...
        with col2:
            ...
            st.markdown(f"See all type info [here]({details_url}).")
        with col3:
            st.write("")
